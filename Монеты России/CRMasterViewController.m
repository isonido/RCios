...
- (void)dataChange
{
    ...
    if (_rowSerial == 58) {
        ...
        NSArray *serialResult = [[CRData fetchData] filteredArrayUsingPredicate:serial];
        _data = serialResult;
        _alphabet = [[NSArray alloc]initWithObjects:@"2022",nil];
    ...
    if (_rowSerial == 61) {
        ...
        NSArray *serialResult = [[CRData fetchData] filteredArrayUsingPredicate:serial];
        _data = serialResult;
        _alphabet = [[NSArray alloc]initWithObjects:@"2022",@"2021",nil];
    ...
    if (_rowSerial == 84) {
        ...
        NSArray *serialResult = [[CRData fetchData] filteredArrayUsingPredicate:serial];
        _data = serialResult;
        _alphabet = [[NSArray alloc]initWithObjects:@"2020",@"2019",@"2017",nil];
    ...
    if (_rowSerial == 93) {
        ...
        NSArray *serialResult = [[CRData fetchData] filteredArrayUsingPredicate:serial];
        _data = serialResult;
        _alphabet = [[NSArray alloc]initWithObjects:@"2022",@"2021",@"2020",@"2019",@"2018",@"2017",@"2016",@"2015",@"2014",@"2013",@"2012",@"2011",@"2010",@"2009",@"2008",@"2007",@"2006",@"2005",@"2004",@"2003",@"2002",@"2000",@"1999",@"1998",@"1997",
    ...
    if (_rowSerial == 99) {
        ...
        NSArray *serialResult = [[CRData fetchData] filteredArrayUsingPredicate:serial];
        _data = serialResult;
        _alphabet = [[NSArray alloc]initWithObjects:@"2022",@"2021",@"2019",@"2018",@"2016",@"2014",@"2013",@"2011",@"2010",@"2009",@"2008",@"2007",@"2006",@"2005",nil];
    ...
    if (_rowSerial == 100) {
        ...
        NSArray *serialResult = [[CRData fetchData] filteredArrayUsingPredicate:serial];
        _data = serialResult;
        _alphabet = [[NSArray alloc]initWithObjects:@"2022",@"2021",@"2020",@"2019",@"2018",@"2017",nil];
        _betabet = [[NSArray alloc]initWithObjects:@"3 рубля",@"25 рублей", nil];
    ...
    if (_rowSerial == 109) {
        ...
        NSArray *serialResult = [[CRData fetchData] filteredArrayUsingPredicate:serial];
        _data = serialResult;
        _alphabet = [[NSArray alloc]initWithObjects:@"2020",@"2015",@"2011",@"2008",@"2004",@"2000",@"1997",@"1996",@"1995",@"1994",@"1993",nil];
